...
ws = run.experiment.workspace   # retrieve the current workspace
ds = Dataset.get_by_name(ws,name='bankchurn2')


#ds = Dataset.Tabular.from_delimited_files(path="Churn_Modelling_train.csv")
